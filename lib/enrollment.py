...
class Enrollment:
    ...
    def aggregate_enrollments_per_day(cls):
        enrollment_count = {}
        # Iterate through all the enrollments and create a Dictionary where
        # the key is the date and the value is the count of enrollments on that date.
        # We increment the count every time we see an enrollment on the same date
